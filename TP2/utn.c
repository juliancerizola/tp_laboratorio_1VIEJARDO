...
int msj(int numero)
{
    switch(numero) /** Negativos para errores. 0 o no listados error generico o desconocido */
    {
        case 1:
            printf(" Hecho!\n\n");
            break;
        case 2:
            printf("\n\n\t   Adios!\n\n");
            break;
        case -1: // Sin empleados dados de alta
            printf("\n ERROR - No hay ningun %s dado de alta (opcion 1)\n\n",ENTIDAD);
            break;
        case -2: // Opcion no valida
            printf("\n ERROR - Opcion no valida (entre 1 y 5)\n\n");
            break;
        case -3: // Opcion no valida
            printf("\n ERROR - Opcion no valida (entre 1 y 2)\n\n");
            break;
        case -4:
            printf("\n ERROR - Opcion no valida (entre 1 y 4)\n\n");
            break;
        case -5:
            printf("\n No existe este ID\n");
            break;
